...
Prioridade em andamento: [Security Hardening v1](PRD-SECURITY-HARDENING-V1.md) — baseline e minimização dos access logs implementados; demais gates pendentes.
